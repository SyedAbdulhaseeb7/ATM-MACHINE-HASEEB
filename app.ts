...
const users: { name: string; pincode: number; balance: number; }[] = []; // Array to store user information
...
async function atm(user: { name?: string; pincode?: number; balance: number; }) {
